...
public record UpdateTaskRequestDto(
    ...
    private static final String ERROR_MESSAGE_PRIORITY = "Task priority must be provide";

    private static final String ERROR_MESSAGE_STATUS = "Task status must be provide";
}
